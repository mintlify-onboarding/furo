...
여러분은 Furo를 통해 React 어플리케이션에 빠르게 로그인 / 회원가입을 구현하고, 인증된 사용자의 정보를 활용할 수 있습니다. 이 가이드는 Flutter에서 Furo 로그인을 구현하는 방법을 안내합니다.
...
### 1.1 web\_auth 라이브러리 설치 및 사용법

이번 가이드에서 저희는 [flutter\_web\_auth](https://pub.dev/documentation/flutter%5Fweb%5Fauth/latest/)라는 라이브러리를 사용합니다. 라이브러리에 관한 사항은 링크를 참고해주세요.
...
![](/images/getting-started/Screenshot%20from%202023-05-08%2014-14-30.png)
...
{deeplink\_name}과 {scheme}를 설정하시면 됩니다.

프로젝트를 시작 후 로그인 버튼을 눌러 furo에 로그인합니다.


![](/images/getting-started/test.gif)
